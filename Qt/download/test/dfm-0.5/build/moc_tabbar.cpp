...
static const char qt_meta_stringdata_tabbar[] = {
    "tabbar\0\0data,newPath,cutList\0"
    "dragDropTab(const QMimeData*,QString,QStringList)\0"
    "closeTab()\0"
};
...
int tabbar::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: dragDropTab((*reinterpret_cast< const QMimeData*(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< QStringList(*)>(_a[3]))); break;
...
// SIGNAL 0
void tabbar::dragDropTab(const QMimeData * _t1, QString _t2, QStringList _t3)
{
